...
let suggestionList : HTMLElement = document.getElementById("suggestions")!;
let sun : HTMLInputElement = <HTMLInputElement>document.getElementById("sun")!;
let moon : HTMLInputElement = <HTMLInputElement>document.getElementById("moon")!;
let rising : HTMLInputElement = <HTMLInputElement>document.getElementById("rising")!;
...
function postAndUpdate(): void {
  ...
  //  Remember to add a type annotation for the response data using the Matches type you defined above!
        fetch('http://127.0.0.1:4567/endpoint', {
          method: 'POST',
          headers: {
...
document.addEventListener("keyup", (key) => {
  if (key.code === "KeyR"){
  updateValues("Scorpio", "Gemini", "Capricorn")
      .then(() => postAndUpdate())
